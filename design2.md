...
description: The most playful B2B SaaS interface in the GTM-data category. A cream-tinted white canvas (#fffaf0) holds dark-navy ink type and 3D-rendered claymation illustrations (mountains, mascot characters, peach/ochre/lavender landscapes) as the dominant brand voltage. Saturated single-color feature cards in a 6-color palette carry every long-scroll page; Plain Black display type at weight 500 with negative letter-spacing gives warmth without bombast. The cream-throughout palette — including a cream (never dark) footer — is the system contract.
